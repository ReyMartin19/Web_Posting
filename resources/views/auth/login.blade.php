...
@section('content')
<div class="flex  bg-[#0e1320] text-white border-none rounded-md">
    <!-- Left: Login Form -->
            ...
            <form action="/login" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input id="email" type="email" name="email" required
                        class="mt-2 block w-full rounded-md bg-[#1a1f2e] px-3 py-2 text-white placeholder-gray-500 focus:ring-2 focus:ring-indigo-500 focus:outline-none">
                </div>
    ...
    <!-- Right: Text Context -->
    <div class="hidden lg:flex w-1/2 bg-[#0b0f1a] items-center justify-center p-12 border-none rounded-lg">
